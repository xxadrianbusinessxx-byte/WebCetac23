...
import {
  SELECT_TUTOR,
  buscarTutorPorId,
  contraseñaInicialTutorDesdeCurp,
  eliminarCredencialesIniciales,
  existeClaveTutor,
  generarClaveTutor,
  generarUsuarioUnico,
 ...
 *
 * Consultas por `tutor_id` / `clave_tutor` / `usuario`, la relación
 * `tutor_alumnos`, el tutor principal del alumno y la consolidación de tutores
 * (crear/reemplazar, desactivar relaciones y tutores huérfanos).
 *
