...
const m = await import("../lib/escolar/ciclo/evaluaciones.ts");
const hor = await import("../lib/escolar/horario/horario-importar.ts");
const ctx = await import("../lib/escolar/ciclo/contexto-ciclo.ts");
