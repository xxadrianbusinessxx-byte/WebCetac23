import { CARPETA_DECORACIONES_PUBLIC, LOGO_ESQUINAS_ARCHIVO } from "@/lib/decoraciones/config";
import { DECORACIONES_GENERADAS } from "@/lib/decoraciones/imagenes-generadas";
