...
// Ejecutar (Node carga los .ts de lib/ directamente; no hay paso de compilar): node scripts/test-roster-validacion.mjs
const R = await import("../lib/escolar/catalogo/roster-validacion.ts");
